...
set_clock_uncertainty -hold 0.1 [get_clocks tag_clk]
set_clock_uncertainty -setup 0.05 [get_clocks bp_clk]
set_clock_uncertainty -hold 0.1 [get_clocks bp_clk]
set_clock_uncertainty -setup 0.05 [get_clocks io_master_clk]
set_clock_uncertainty -hold 0.1 [get_clocks io_master_clk]
set_clock_uncertainty -setup 0.05 [get_clocks router_clk]
set_clock_uncertainty -hold 0.1 [get_clocks router_clk]
set_clock_uncertainty -setup 0.05 [get_clocks sdi_a_clk]
set_clock_uncertainty -hold 0.1 [get_clocks sdi_a_clk]
set_clock_uncertainty -setup 0.05 [get_clocks sdo_a_tkn_clk]
set_clock_uncertainty -hold 0.1 [get_clocks sdo_a_tkn_clk]
set_clock_uncertainty -setup 0.05 [get_clocks sdi_b_clk]
set_clock_uncertainty -hold 0.1 [get_clocks sdi_b_clk]
set_clock_uncertainty -setup 0.05 [get_clocks sdo_b_tkn_clk]
set_clock_uncertainty -hold 0.1 [get_clocks sdo_b_tkn_clk]
